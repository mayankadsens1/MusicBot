        ...
        try {
            ...
            if (loadType === "playlist") {
                ...
                collector.on('collect', async (i) => {
                    ...
                    await interaction.editReply({ 
                        embeds: [embed.setDescription(`\`✔\` |  Added **[${track.info.title}](${track.info.uri})** to playlist \`${selectedPlaylistName}\`.`).setFooter({ iconURL: "https://i.ibb.co/svyfFD4G/cod.jpgg", text: "CodeX Music" })],
                        components: [] 
                    });
                    collector.stop();
                });
